...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { author: @discussion.author, description: @discussion.description, name: @discussion.name, subforum_id: @discussion.subforum_id }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { author: @discussion.author, description: @discussion.description, name: @discussion.name, subforum_id: @discussion.subforum_id }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
